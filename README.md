...
The fourth and fifth bytes seem to always be `18 00`. Perhaps 18 is a cute way to reference IB? For monophonic files (which includes many of the \*.JR files which are duplicates of the \*.IB ones), the next 6 bytes are all `00`s, whereas for polyphonic files, positions 0x06 and 0x08 tend to be `00` and `00` or `00` and `01`.
...
| 020    | <code style="color : Green">00</code><code style="color : Red">C6 01 72 81 91 71 83 91 74</code>`80`                |
